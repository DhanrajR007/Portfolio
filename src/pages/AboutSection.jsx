...
const AboutSection = () => {
  return (
    <div className="min-h-screen w-full bg-white text-black rounded-t-[50px] px-10 py-8 max-[768px]:px-5">
      {/* Heading */}
      <div className="text-(--color-primary) font-medium font-[Smooch Sans] text-2xl max-[768px]:text-xl mb-6">
        // About
      </div>

      {/* Top Text Section */}
      <div className="flex justify-between w-full flex-wrap py-5 gap-8">
      ...
      {/* Bottom Section */}
      <div className="flex py-20 gap-12 items-center max-[1024px]:flex-col max-[1024px]:py-10">
        {/* Image */}
