...
const ServicesSection = () => {
  return (
    <div className="bg-black text-white py-16 px-10 min-h-screen">
      {/* Heading */}
      <div className="text-(--color-primary) font-medium font-[Smooch Sans] text-3xl text-center">
        // Services
      </div>
      ...
      <div className="flex flex-wrap justify-center gap-10 pt-12">
        ...
        <div className="w-[30vw] max-[1024px]:w-[45vw] max-[768px]:w-full py-8 px-6 rounded-2xl bg-zinc-900 border border-white/10 flex flex-col items-center text-center">
          ...
          <div className="h-[18vw] w-full max-[768px]:h-[50vw] mb-5">
            <img className="w-full h-full object-cover rounded-xl" src="./f2.png" alt="" />
          </div>
